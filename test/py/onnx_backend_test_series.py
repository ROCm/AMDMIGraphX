...
def create_backend_test(testname=None, target_device = None):
    ...
    if testname:
        ...
        backend_test.exclude(r'test_clip_default_min_cpu')
        backend_test.exclude(r'test_concat_1d_axis_0_cpu')
        backend_test.exclude(r'test_concat_1d_axis_negative_1_cpu')
        backend_test.exclude(r'test_concat_2d_axis_0_cpu')
        backend_test.exclude(r'test_concat_2d_axis_1_cpu')
        backend_test.exclude(r'test_concat_2d_axis_negative_1_cpu')
        backend_test.exclude(r'test_concat_2d_axis_negative_2_cpu')
        backend_test.exclude(r'test_concat_3d_axis_0_cpu')
        backend_test.exclude(r'test_concat_3d_axis_1_cpu')
        backend_test.exclude(r'test_concat_3d_axis_2_cpu')
        backend_test.exclude(r'test_concat_3d_axis_negative_1_cpu')
        backend_test.exclude(r'test_concat_3d_axis_negative_2_cpu')
        backend_test.exclude(r'test_concat_3d_axis_negative_3_cpu')
        backend_test.exclude(r'test_constant_cpu')
        backend_test.exclude(r'test_div_cpu')
        backend_test.exclude(r'test_div_example_cpu')
        ...
        backend_test.exclude(r'test_mul_bcast_cpu')
        backend_test.exclude(r'test_pow_cpu')
        backend_test.exclude(r'test_pow_example_cpu')
        backend_test.exclude(r'test_shape_cpu')
        backend_test.exclude(r'test_shape_example_cpu')
        ...
        backend_test.exclude(r'test_sub_cpu')
        backend_test.exclude(r'test_sub_example_cpu')
        backend_test.exclude(r'test_AvgPool1d_cpu') 
        backend_test.exclude(r'test_AvgPool1d_stride_cpu') 
        backend_test.exclude(r'test_operator_basic_cpu') 
        backend_test.exclude(r'test_operator_concat2_cpu') 
        backend_test.exclude(r'test_operator_pow_cpu') 
        backend_test.exclude(r'test_operator_symbolic_override_nested_cpu') 
        backend_test.exclude(r'test_add_bcast_cpu')
        backend_test.exclude(r'test_averagepool_2d_ceil_cpu')
        backend_test.exclude(r'test_clip_cpu')
        backend_test.exclude(r'test_clip_default_inbounds_cpu')
        backend_test.exclude(r'test_clip_default_max_cpu')
        backend_test.exclude(r'test_clip_example_cpu')
        backend_test.exclude(r'test_clip_inbounds_cpu')
        backend_test.exclude(r'test_clip_outbounds_cpu')
        backend_test.exclude(r'test_clip_splitbounds_cpu')
        ...
        backend_test.exclude(r'test_div_bcast_cpu')
        ...
        backend_test.exclude(r'test_gemm_all_attributes_cpu')
        backend_test.exclude(r'test_gemm_alpha_cpu')
        backend_test.exclude(r'test_gemm_beta_cpu')
        backend_test.exclude(r'test_gemm_default_matrix_bias_cpu')
        backend_test.exclude(r'test_gemm_default_no_bias_cpu')
        backend_test.exclude(r'test_gemm_default_scalar_bias_cpu')
        backend_test.exclude(r'test_gemm_default_single_elem_vector_bias_cpu')
        backend_test.exclude(r'test_gemm_default_vector_bias_cpu')
        backend_test.exclude(r'test_gemm_default_zero_bias_cpu')
        backend_test.exclude(r'test_gemm_transposeA_cpu')
        backend_test.exclude(r'test_gemm_transposeB_cpu')
        ...
        backend_test.exclude(r'test_matmul_2d_cpu')
        backend_test.exclude(r'test_matmul_3d_cpu')
        backend_test.exclude(r'test_matmul_4d_cpu')
        ...
        backend_test.exclude(r'test_pow_bcast_array_cpu')
        backend_test.exclude(r'test_pow_bcast_scalar_cpu')
        ...
        backend_test.exclude(r'test_softmax_negative_axis_cpu')
        ...
        backend_test.exclude(r'test_sub_bcast_cpu')
        ...
        backend_test.exclude(r'test_Softplus_cpu')
        backend_test.exclude(r'test_operator_addmm_cpu') 
        backend_test.exclude(r'test_operator_mm_cpu')
