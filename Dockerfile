...
RUN PATH=/opt/cmake/bin:$PATH cget -p /usr/local install ROCmSoftwarePlatform/llvm-project-mlir@25f75ac026083128acb573f48620b90611b91e45 -DBUILD_MIXR_TARGET=On
