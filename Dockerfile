...
RUN cget -p /usr/local install ROCmSoftwarePlatform/rocMLIR@fadd7d3c12b5e373a95d74d44cdba05ca31fc2db -DBUILD_MIXR_TARGET=On -DLLVM_ENABLE_ZSTD=Off -DLLVM_ENABLE_THREADS=Off
