...
RUN mkdir -p $ONNX_HOME/.onnx/models
ADD https://s3.amazonaws.com/download.onnx/models/opset_9/bvlc_alexnet.tar.gz /tmp/
RUN tar -xzvf /tmp/bvlc_alexnet.tar.gz --directory $ONNX_HOME/.onnx/models/ && rm /tmp/bvlc_alexnet.tar.gz
