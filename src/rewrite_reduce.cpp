...
struct find_softmax
{
    ...
    void apply(module& m, const match::matcher_result& r) const
    {
        ...
        auto maxb = m.insert_instruction(ins, make_op("multibroadcast", {{"out_lens", input->get_shape().lens()}}), max);
        ...
        auto sumb = m.insert_instruction(ins, make_op("multibroadcast", {{"out_lens", input->get_shape().lens()}}), sum);
