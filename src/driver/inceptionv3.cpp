...
migraphx::program inceptionv3(unsigned batch) // NOLINT(readability-function-size)
{
    ...
    pooling493.mode    = migraphx::op::pooling_mode::kMax;
    ...
    pooling500.mode    = migraphx::op::pooling_mode::kMax;
    ...
    pooling519.mode    = migraphx::op::pooling_mode::kAvg;
    ...
    pooling542.mode    = migraphx::op::pooling_mode::kAvg;
    ...
    pooling565.mode    = migraphx::op::pooling_mode::kAvg;
    ...
    pooling582.mode    = migraphx::op::pooling_mode::kMax;
    ...
    pooling611.mode    = migraphx::op::pooling_mode::kAvg;
    ...
    pooling643.mode    = migraphx::op::pooling_mode::kAvg;
    ...
    pooling675.mode    = migraphx::op::pooling_mode::kAvg;
    ...
    pooling707.mode    = migraphx::op::pooling_mode::kAvg;
    ...
    pooling730.mode    = migraphx::op::pooling_mode::kMax;
    ...
    pooling758.mode    = migraphx::op::pooling_mode::kAvg;
    ...
    pooling789.mode    = migraphx::op::pooling_mode::kAvg;
    ...
    pooling794.mode    = migraphx::op::pooling_mode::kAvg;
