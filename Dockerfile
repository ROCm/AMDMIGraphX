...
RUN cget -p /usr/local install ROCmSoftwarePlatform/rocMLIR@426d8364a262b767ee6d6d6aab4dab89f3b367c3 -DBUILD_MIXR_TARGET=On -DLLVM_ENABLE_ZSTD=Off -DLLVM_ENABLE_THREADS=Off
