...
def gelu_new_test():
    ...
    three_tensor = helper.make_tensor(name='three_val',
                                      ...
                                      vals=three_val.astype(np.float))

    three = onnx.helper.make_node('Constant',
                                  inputs=[],
                                  outputs=['three'],
                                  value=three_tensor)
    ...
    const_tensor = helper.make_tensor(name='const_val',
                                      ...
                                      vals=const_val.astype(np.float))

    const = onnx.helper.make_node('Constant',
                                  inputs=[],
                                  outputs=['const'],
                                  value=const_tensor)
    ...
    add_x = onnx.helper.make_node('Add',
                                  inputs=['0', 'mul_const_out'],
                                  outputs=['add_x_out'])
    ...
    mul_half = onnx.helper.make_node('Mul',
                                     inputs=['half', 'tanh_out'],
