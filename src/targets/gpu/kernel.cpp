...
extern hipError_t hipExtModuleLaunchKernel(hipFunction_t, uint32_t,
                                    uint32_t, uint32_t,
                                    uint32_t, uint32_t,
                                    uint32_t, size_t,
...
void kernel::launch(hipStream_t stream, std::size_t global, std::size_t local, const std::vector<std::pair<std::size_t, void*>>& args)
{
