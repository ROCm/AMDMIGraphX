...
RUN cget -p /usr/local install ROCmSoftwarePlatform/rocMLIR@2a4b4650fd7e7d71c87c2b8f1f5ac9d302ca2a64 -DBUILD_MIXR_TARGET=On -DLLVM_ENABLE_ZSTD=Off -DLLVM_ENABLE_THREADS=Off
...
ENV ASAN_OPTIONS=detect_stack_use_after_return=1:check_initialization_order=1:strict_init_order=1:detect_leaks=0
