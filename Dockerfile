...
# Install cget
#RUN pip3 install cget && pip3 install numpy==1.18.5 && pip3 install onnx==1.7.0 && pip3 install typing==3.7.4
RUN pip3 install cget && pip3 install numpy && pip3 install onnx && pip3 install typing==3.7.4
