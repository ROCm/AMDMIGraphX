...
TEST_CASE(dominate_conflicts)
{
    ...
    t.check_conflicts(p, {{onep1}, {onep2}});
    t.check_conflicts(p, {{onep3}, {onep4}});

    t.check_conflicts(p, {{onep1, onep2}, {onep3, onep4}}, false);
    t.check_conflicts(p, {{binary1}, {binary2}}, false);
}
