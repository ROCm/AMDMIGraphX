...
void layernorm(hipStream_t stream, const argument& result, const argument& arg1, const argument& arg2, const argument& arg3)
{
    ...
    hip_visit_all(result, arg1, arg2, arg3, reduce_slice, reduce_output_shape)([&](auto output, auto input, auto scale, auto bias, auto reduce_shape, auto reduce_output) {
        ...
        mi_launch(stream, reduce_output, reduce_shape, block_size)(
            [=](auto idx, auto global, auto local) __device__ {
                global([&](auto i) __device__ {
                    ...
                    k = 0;
                    auto m =
                        block_reduce<max_block_size>(idx, sum{}, 0, relements, [&](auto) __device__ {
                            k++;
                            return x[k-1];
                        }) / relements;
...
// void layernorm_tf(hipStream_t stream, const argument& result, const argument& arg, const argument& arg2, const argument& arg3)
// {
...
//     shape reduce_slice{output_shape.type(), reduce_lens};
//     shape reduce_output_shape{output_shape.type(), reduce_output_lens};
//     hip_visit_all(result, arg, arg2, arg3, reduce_slice, reduce_output_shape)([&](auto output, auto input, auto scale, auto bias, auto reduce_shape, auto reduce_output) {
//         using value_type = typename decltype(input)::value_type;
