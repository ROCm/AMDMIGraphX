...
struct parse_gather_elements : op_parser<parse_gather_elements>
{
                          ...
                          std::vector<instruction_ref> args) const
    {
        ...
        auto l_shape_idx =
            info.mm->add_literal(literal(ind_s, data_indices.begin(), data_indices.end()));
        auto l_dim_idx = info.mm->add_literal(literal(ind_s, vec_axis_ind.begin(), vec_axis_ind.end()));
        auto l_stride  = info.mm->add_literal(literal{{ind_s.type(), {1}}, {axis_stride}});
