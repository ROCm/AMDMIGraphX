...
# Add rocm repository
RUN sh -c 'echo deb [arch=amd64 trusted=yes] http://repo.radeon.com/rocm/apt/.apt_5.3/ ubuntu main > /etc/apt/sources.list.d/rocm.list'
...
RUN cget -p $PREFIX install ccache@v4.6.3
