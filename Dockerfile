...
RUN env PATH=/opt/cmake/bin:$PATH cget -p /usr/local install ROCmSoftwarePlatform/rocMLIR@$(cat /mlir-requrements.txt) -DBUILD_FAT_LIBROCKCOMPILER=On
