...
RUN cget -p /usr/local install ROCmSoftwarePlatform/rocMLIR@b8c0a51c7bd1b4d5a70c8389c40fb451fe8652a3 -DBUILD_MIXR_TARGET=On -DLLVM_ENABLE_ZSTD=Off -DLLVM_ENABLE_THREADS=Off
