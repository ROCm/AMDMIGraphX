...
migraphx::program inceptionv3(unsigned batch) // NOLINT(readability-function-size)
{
    ...
    pooling493.mode    = migraphx::op::pooling::kMax;
    ...
    pooling500.mode    = migraphx::op::pooling::kMax;
    ...
    pooling519.mode    = migraphx::op::pooling::kAvg;
    ...
    pooling542.mode    = migraphx::op::pooling::kAvg;
    ...
    pooling565.mode    = migraphx::op::pooling::kAvg;
    ...
    pooling582.mode    = migraphx::op::pooling::kMax;
    ...
    pooling611.mode    = migraphx::op::pooling::kAvg;
    ...
    pooling643.mode    = migraphx::op::pooling::kAvg;
    ...
    pooling675.mode    = migraphx::op::pooling::kAvg;
    ...
    pooling707.mode    = migraphx::op::pooling::kAvg;
    ...
    pooling730.mode    = migraphx::op::pooling::kMax;
    ...
    pooling758.mode    = migraphx::op::pooling::kAvg;
    ...
    pooling789.mode    = migraphx::op::pooling::kAvg;
    ...
    pooling794.mode    = migraphx::op::pooling::kAvg;
