...
// template<class T>
// struct base_function_roctx
// {
//     virtual std::function<T> return_func() const = 0;
//     virtual void call_roctx_lib() const = 0;
// };

// struct tx_roctxMarkA: base_function_roctx
// {
//     migraphx::dynamic_loader lib;
//     std::function<void(const char*) returnFunc() const override
//     {
//         return lib.get_function<void(const char*)>("roctxMarkA");
//     }
//     void call_roctx_lib(migrahx::dynamic_loader in_lib)
//     {
//         lib = in_lib;
//     }
// };
...
// struct start_marker
// {
//     void trace_ins(migraphx::dynamic_loader lib, std::string marker_string)
//     {
//         std::function<void(const char*)> sym_roctxMarkA = lib.get_function<void(const char*)>("roctxMarkA");
//         sym_roctxMarkA(marker_string.c_str());
//     }
// };

// struct start_range
// {
//     uint64_t trace_ins(migraphx::dynamic_loader lib, std::string range_string)
//     {
//         std::function<uint64_t(const char*)> sym_roctxRangeStartA = lib.get_function<uint64_t(const char*)>("roctxRangeStartA");
...
// struct start_push
// {
//     void trace_ins(migraphx::dynamic loader lib, std::string marker_string, std::string range_string)
//     {
//         std::function<void(const char*)> sym_roctxMarkA = lib.get_function<void(const char*)>("roctxMarkA");
//         std::function<uint64_t(const char*)> sym_roctxRangeStartA = lib.get_function<uint64_t(const char*)>("roctxRangeStartA");
//         std::function<int(const char*)> sym_roctxRangePushA = lib.get_function<int(const char*)>("roctxRangePushA");
//         sym_roctxMarkA(marker_string);
//     }
// };
...
// struct call_marker
// {
//     void run(migraphx::dynamic loader lib, std::string string_in)
//     {
//         ////     std::function<uint64_t(const char*)> sym_roctxRangeStartA = lib.get_function<uint64_t(const char*)>("roctxRangeStartA");
//         //     std::function<int(const char*)> sym_roctxRangePushA = lib.get_function<int(const char*)>("roctxRangePushA");

//         std::function<void(const char*)> sym_roctxRangeStartA = lib.get_function<void(const char*)>("roctxMarkA");
//         sym_roctxMarkA(string_in);
//     }
// };
...
// template<typename T>
// class roctx_func_wrap
// {
//     const std::function<T> func; // 
//     const migraphx::dynamic_loader lib = migraphx::dynamic_loader{"libroctx64.so"}; //instantiate for each? looks bad.
//     const std::string func_name;

// public:
    
//     roctx_func_wrap(std::string roctx_str): func_name(roctx_str) { }

//     std::function<T> get_func()
//     {
//         func = lib.get_function<T>(func_name);
//         return func;
//     }
//     // some of the functions return integer, some do not. some take input and some does not take input...
// };
...
//     void trace_mark(migraphx::instruction ins, std::string in_string)
//     {
//         sym_roctxMarkA(in_string);
//         sym_roctxRangeStartA(ins.name());
//     }

//     void trace_start(migraphx::instruction ins)
//     {
//         sym_roctxRangePushA(ins.name());
//     }
...
//     void trace_ins_start(instruction_ref ins, std::string in_string)
//     {
//         sym_roctxRangePushA(ins->name().c_str());
//     }

//     void trace_ins_end(instruction_ref ins, std::string in_string)
//     {
//         sym_roctxRangePop();
//     }
// };

// struct roctx_mark_ins
// {
//     migraphx::dynamic_loader lib = migraphx::dynamic_loader{"libroctx64.so"};
//     std::function<int(const char*)> sym_roctxRangePushA;
