...
RUN cget -p /usr/local install ROCmSoftwarePlatform/rocMLIR@cd1523fb61c7f46b755b61277e83aaf67ac3666f -DBUILD_MIXR_TARGET=On -DLLVM_ENABLE_ZSTD=Off -DLLVM_ENABLE_THREADS=Off
