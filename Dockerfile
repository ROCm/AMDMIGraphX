...
RUN cget -p /usr/local install ROCmSoftwarePlatform/rocMLIR@7d4aef660bad4ce4a8a581d2448cafd8763417e6 -DBUILD_MIXR_TARGET=On -DLLVM_ENABLE_ZSTD=Off -DLLVM_ENABLE_THREADS=Off
