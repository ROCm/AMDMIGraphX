...
public:
    ...
    virtual bool refitCudaEngineAsync(hipStream_t stream) noexcept = 0;
...
public:
    ...
    virtual bool setOptimizationProfileAsync(int32_t profileIndex, hipStream_t stream) noexcept = 0;
    ...
    virtual bool setInputConsumedEvent(hipEvent_t event) noexcept = 0;
    virtual hipEvent_t getInputConsumedEvent() const noexcept = 0;
    ...
    virtual bool enqueueV3(hipStream_t stream) noexcept = 0;
    ...
    virtual void setAuxStreams(hipStream_t* auxStreams, int32_t nbStreams) noexcept = 0;
...
public:
    ...
    virtual void setProfileStream(const hipStream_t stream) noexcept = 0;
    virtual hipStream_t getProfileStream() const noexcept = 0;
