...
struct miopen_apply
{
    ...
    void init()
    {
        ...
        add_extend_op<hip_rnn_var_sl_last_output<op::rnn_last_cell_output>,
                      op::rnn_last_cell_output>("rnn_last_cell_output");
        add_extend_op<hip_rnn_var_sl_last_output<op::rnn_last_hs_output>, op::rnn_last_hs_output>(
            "rnn_last_hs_output");
