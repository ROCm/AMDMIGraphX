...
* Fixed a GPU accuracy regression in unrolled GRU/LSTM graphs by excluding same-key dots that participate in dependencies from `fuse_horizontal` groups (#5276).
