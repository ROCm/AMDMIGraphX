...
RUN env PATH=/opt/cmake/bin:$PATH cget -p /usr/local install ROCmSoftwarePlatform/rocMLIR@7df563dce193805881bcc2193ea8dc3d52cc1967 -DBUILD_FAT_LIBROCKCOMPILER=On
