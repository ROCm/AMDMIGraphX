...
{
    migraphx::run_passes(
        m, {migraphx::propagate_precision{}, migraphx::dead_code_elimination{}});
}
...
TEST_CASE(simple_input)
{
    ...
    migraphx::module m1;
    {
        ...
        auto convert1 = m1.add_instruction(migraphx::make_op("convert", {{"target_type", migraphx::shape::float_type}}), sqrt);
        auto mul = m1.add_instruction(migraphx::make_op("mul"), convert1, y);
        auto convert2 = m1.add_instruction(migraphx::make_op("convert", {{"target_type", migraphx::shape::half_type}}), mul);
    ...
    migraphx::module m2;
    {
        ...
        auto convert1 = m2.add_instruction(migraphx::make_op("convert", {{"target_type", migraphx::shape::float_type}}), x);
        ...
        auto convert2 = m2.add_instruction(migraphx::make_op("convert", {{"target_type", migraphx::shape::half_type}}), mul);
