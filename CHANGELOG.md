...
* Fixed system reboot (TDR) when running Topaz SLM model on MIGraphX EP by restoring safety guards in `find_reshape_cont` that prevented incorrect optimization of non-standard tensor layouts.
### Optimized
