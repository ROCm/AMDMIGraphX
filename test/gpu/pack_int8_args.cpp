...
TEST_CASE(quant_dot)
{
    auto create_module = [] {
        ...
        auto r  = migraphx::add_apply_alpha_beta<int32_t>(m, {l1, l2, l3}, migraphx::make_op("quant_dot"), 1, 1);
        m.add_return({r});
        return m;
    };
...
TEST_CASE(quant_dot_trans)
{
    auto create_module = [] {
        ...
        auto r = migraphx::add_apply_alpha_beta<int32_t>(m, {tl1, tl2}, migraphx::make_op("quant_dot"), 3);
        m.add_return({r});
        return m;
    };
