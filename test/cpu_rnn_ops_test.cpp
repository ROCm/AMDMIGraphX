...
TEST_CASE(rnn_forward)
{
    ...
    // concatenation of hidden states as program output
    {
        ...
        hs_concat.back().visit([&](auto output) { hs_data.assign(output.begin(), output.end()); });
    ...
    // rnn last output as program output
    {
        ...
        last_output.back().visit([&](auto out) { last_output_data.assign(out.begin(), out.end()); });
...
TEST_CASE(lstm_forward)
{
    ...
    // forward, last_output as program output
    {
        ...
        last_hs.back().visit([&](auto output) { output_data.assign(output.begin(), output.end()); });
...
TEST_CASE(lstm_reverse)
{
    ...
    // reverse, concatenation of hidden states as program output
    {
        ...
        auto hs_concat = p.eval({});
        std::vector<float> output_data;
        hs_concat.back().visit([&](auto output) { output_data.assign(output.begin(), output.end()); });
        std::vector<float> output_data_gold{
