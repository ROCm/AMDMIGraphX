...
migraphx::program alexnet(unsigned batch) // NOLINT(readability-function-size)
{
    ...
    float dot43_alpha            = 1;
    float dot43_beta             = 1;
    auto mx43 = migraphx::mul_with_alpha_beta(*mm, {mx40, mx41, mx42}, dot43_alpha, dot43_beta);
    ...
    float dot48_alpha            = 1;
    float dot48_beta             = 1;
    auto mx48 = migraphx::mul_with_alpha_beta(*mm, {mx45, mx46, mx47}, dot48_alpha, dot48_beta);
    ...
    float dot52_alpha            = 1;
    float dot52_beta             = 1;
    migraphx::mul_with_alpha_beta(*mm, {mx49, mx50, mx51}, dot52_alpha, dot52_beta);
    return p;
}
