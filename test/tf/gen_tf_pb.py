...
def add_test(g1):
    with g1.as_default():
        g1_input = tf.compat.v1.placeholder(tf.float32, shape=(1, 2, 2, 3), name='0')
        g2_input = tf.compat.v1.placeholder(tf.float32, shape=(1, 2, 2, 3), name='1')
...
def argmax_test(g1):
    with g1.as_default():
        g1_input = tf.compat.v1.placeholder(tf.float32, shape=(3, 4, 5, 6), name='0')
...
def batchmatmul_test(g1):
    with g1.as_default():
        g1_input = tf.compat.v1.placeholder(tf.float32, shape=(1, 2, 8, 4), name='0')
        g2_input = tf.compat.v1.placeholder(tf.float32, shape=(1, 2, 4, 8), name='1')
        tf.matmul(g1_input,
                  g2_input,
                  transpose_a=True,
                  transpose_b=True,
...
def batchnorm_test(g1):
    with g1.as_default():
        g1_input = tf.compat.v1.placeholder(tf.float32, shape=(1, 16, 16, 32), name='0')
        ...
        g1_variance = tf.compat.v1.placeholder(tf.float32, shape=(32), name='4')
...
def biasadd_test(g1):
    with g1.as_default():
        g1_input = tf.compat.v1.placeholder(tf.float32, shape=(1, 1, 1, 500), name='0')
...
def cast_test(g1):
    with g1.as_default():
        g1_input = tf.compat.v1.placeholder(tf.float32, shape=(1, 3, 16, 16), name='0')
...
def concat_test(g1):
    with g1.as_default():
        g1_input = tf.compat.v1.placeholder(tf.float32, shape=(4, 7, 3), name='0')
        g2_input = tf.compat.v1.placeholder(tf.float32, shape=(4, 2, 3), name='1')
...
def conv_test(g1):
    with g1.as_default():
        g1_input = tf.compat.v1.placeholder(tf.float32, shape=(1, 16, 16, 3), name='0')
...
def expanddims_test(g1):
    with g1.as_default():
        g1_input = tf.compat.v1.placeholder(tf.float32, shape=(2, 3, 4), name='0')
...
def mul_test(g1):
    with g1.as_default():
        g1_input = tf.compat.v1.placeholder(tf.float32, shape=(1, 1, 1, 16), name='0')
        g2_input = tf.compat.v1.placeholder(tf.float32, shape=(1, 1, 1, 16), name='1')
...
def pack_test_nhwc(g1):
    with g1.as_default():
        g1_input = tf.compat.v1.placeholder(tf.float32, shape=(1, 1, 1, 2), name='0')
        g2_input = tf.compat.v1.placeholder(tf.float32, shape=(1, 1, 1, 2), name='1')
        g3_input = tf.compat.v1.placeholder(tf.float32, shape=(1, 1, 1, 2), name='2')
...
def slice_test(g1):
    with g1.as_default():
        g1_input = tf.compat.v1.placeholder(tf.float32, shape=(5, 10), name='0')
...
def split_test(g1):
    with g1.as_default():
        g1_input = tf.compat.v1.placeholder(tf.float32, shape=(5, 30), name='0')
...
def squeeze_test(g1):
    with g1.as_default():
        g1_input = tf.compat.v1.placeholder(tf.float32, shape=(1, 2, 3, 1), name='0')
...
def stridedslice_test(g1):
    with g1.as_default():
        g1_input = tf.compat.v1.placeholder(tf.float32, shape=(1, 1, 1, 10), name='0')
...
def stridedslice_masks_test(g1):
    with g1.as_default():
        g1_input = tf.compat.v1.placeholder(tf.float32, shape=(1, 3, 3, 10), name='0')
...
def variable_batch_test(g1):
    with g1.as_default():
        g1_input = tf.compat.v1.placeholder(tf.float32, shape=(0, 3, 16, 16), name='0')
