...
struct context
{
    ...
    struct private_detail_te_handle_type : private_detail_te_handle_base_type
    {
        ...
        void record_event(int event, int stream) override
        {
            return private_detail_te_value.record_event(event, stream);
        }
        void wait_event(int stream, int event) override
        {
            return private_detail_te_value.wait_event(stream, event);
        }
