...
RUN env PATH=/opt/cmake/bin:$PATH cget -p /usr/local install ROCmSoftwarePlatform/rocMLIR@fa2f7b0bf8fec5da276b9e4646a679b0449e3313 -DBUILD_FAT_LIBROCKCOMPILER=On
